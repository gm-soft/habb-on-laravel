    ...
    <div class="slides">
        ...
        <section>
            ...
            <section>
                ...
                <div class="mt-3">
                    Бизнес-процессы команды, которые могли быть оптимизированы
                </div>
                <ul>
                    <li>Генерация аккаунтов и возврат HABB ID зарегистрировавшемуся</li>
                    <li>Перенос информации в CRM систему</li>
                    <li>Создание команд и присвоение очков</li>
                    <li>Нет возможности создать публичную страницу рейтингов</li>
                </ul>
            </section>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>Обработка и учет информации. Присвоение очков. Автоматический рейтинг</li>
                    <li>Новости для игроков и команд</li>
                </ul>
            </section>

            <section>
                <h4>Тип информации в ИС</h4>
                <ul>
                    <li>Контактная и личная информация игрока</li>
                    <li>Команды. Создание и утверждение</li>
                    <li>Присвоение очков, формирование рейтинга автоматически</li>
                </ul>
            </section>

            <section>
                <h4>Сбор (генерация) информации</h4>
                <p>
            ...
            <section>
                ...
                <p>
                    Базы данных системы и автоматическая синхронизация с внешними ресурсами
                </p>
                <ul>
        ...
        <section>
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>Команды игроков. Заявки на создание</li>
